...
var index$s = async (context, input, customQuery = { addBundleProductsToCart: "addBundleProductsToCart" }, customHeaders = {}) => {
...
var index$r = async (context, input, customQuery = { addProductsToWishlist: "addProductsToWishlist" }, customHeaders = {}) => {
...
var index$q = async (context, input, customQuery = { addSimpleProductsToCart: "addSimpleProductsToCart" }, customHeaders = {}) => {
 ...
 */
var index$p = async (context, customQuery = { availableStores: "availableStores" }, customHeaders = {}) => {
...
var index$o = async (context, cartId, customHeaders = {}) => context.client.query({
    query: gql__default["default"] `
      ${cartTotalQtyQuery}
    `,
    variables: { cartId },
 ...
 */
var index$n = async (context, params, customQuery = { changeCustomerPassword: "changeCustomerPassword" }, customHeaders = {}) => {
    try {
 ...
 * @param customHeaders (optional) - custom headers that extends the default headers
 */
async function getCmsBlocks(context, identifiers, customQuery = { cmsBlocks: "cmsBlocks" }, customHeaders = {}) {
 ...
 * @param customHeaders (optional) - custom headers that extends the default headers
 */
async function getCmsPage(context, identifier, customQuery = { cmsPage: "cmsPage" }, customHeaders = {}) {
    try {
      ...
      `,
        ...
        // For error in data we don't throw 500, because it's not server error
        if (error.graphQLErrors) {
            consola__default["default"].debug(error);
            return {
                ...error,
                errors: error.graphQLErrors,
                data: null,
 ...
 */
var index$m = async (context, input, customQuery = { createCustomer: "createCustomer" }, customHeaders = {}) => {
    try {
...
var index$l = async (context, customHeaders = {}) => context.client.mutate({
    mutation: gql__default["default"] `
      ${createEmptyCart}
    `,
    context: {
 ...
 */
var index$k = async (context, input, customHeaders = {}) => {
    const { recaptchaToken, ...variables } = input;
    if (context.config.recaptcha.isEnabled) {
        /**
         * recaptcha token verification
 ...
 */
var index$j = async (context, customQuery = { customer: "customer" }, customHeaders = {}) => {
 ...
 */
var index$i = async (context, searchParams, customQuery = { customerOrders: "customerOrders" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
        ...searchParams,
 ...
 *
 */
var index$h = async (context, searchParams, customQuery = { reviews: "reviews" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
    };
...
var index$g = async (context, { mutation, mutationVariables, fetchPolicy, customHeaders, }) => context.client.mutate({
    mutation: gql__default["default"] `
      ${mutation}
    `,
...
var index$f = async (context, { query, queryVariables, fetchPolicy, customHeaders, }) => context.client.query({
    query: gql__default["default"] `
      ${query}
    `,
 ...
 */
var index$e = async (context, params, customQuery = { generateCustomerToken: "generateCustomerToken" }, customHeaders = {}) => {
    try {
        if (context.config.recaptcha.isEnabled) {
            /**
             * recaptcha token verification
...
var index$d = async (context, customHeaders = {}) => {
    try {
        return await context.client.query({
            query: gql__default["default"] `
...
var index$c = async (context, params, customQuery = { shippingMethods: "shippingMethods" }, customHeaders = {}) => {
    const { shippingMethods } = context.extendQuery(customQuery, {
        shippingMethods: {
...
var index$b = async (context, params, customQuery = { mergeCarts: "mergeCarts" }, customHeaders = {}) => {
 ...
 */
var index$a = async (context, searchParams, customQuery = { productReview: "productReview" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
        ...searchParams,
...
var productReviewRatingsMetadata = `
 ...
 */
var index$9 = async (context, customQuery = { productReviewRatingsMetadata: "productReviewRatingsMetadata" }, customHeaders = {}) => {
...
var index$8 = async (context, input, customQuery = { removeProductsFromWishlist: "removeProductsFromWishlist" }, customHeaders = {}) => {
...
async function requestPasswordResetEmail(context, input, customHeaders = {}) {
    ...
    consola__default["default"].debug("[VSF: Magento] requestPasswordResetEmail", JSON.stringify(input, null, 2));
 ...
 */
var index$7 = async (context, customHeaders = {}) => context.client.mutate({
    mutation: gql__default["default"] `
      ${revokeCustomerToken}
    `,
    context: {
...
var index$6 = async (context, input, customQuery = { setBillingAddressOnCart: "setBillingAddressOnCart" }, customHeaders = {}) => {
 ...
 */
var index$5 = async (context, input, customQuery = { updateCustomer: "updateCustomer" }, customHeaders = {}) => {
...
var index$4 = async (context, input, customQuery = { updateCustomerEmail: "updateCustomerEmail" }, customHeaders = {}) => {
 ...
 */
var index$3 = async (context, searchParams, customQuery = { upsellProducts: "upsellProducts" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
        ...searchParams,
 ...
 * Returns product reviews created by the current customer
 */
var index$2 = async (context, searchParams, customQuery = { reviews: "reviews" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
    };
...
var index$1 = async (context, searchParams, customQuery = { wishlist: "wishlist" }, customHeaders = {}) => {
    const defaultParams = {
        pageSize: 10,
        currentPage: 1,
        ...searchParams,
...
var index = async (context, customHeaders = {}) => context.client.query({
    query: gql.gql `
...
var api = /*#__PURE__*/Object.freeze({
  __proto__: null,
  addBundleProductsToCart: index$s,
  addConfigurableProductsToCart: addConfigurableProductsToCart,
  addProductsToCart: addProductsToCart,
  addProductToWishList: index$r,
  addSimpleProductsToCart: index$q,
  ...
  availableStores: index$p,
  cart: cart,
  cartTotalQty: index$o,
  categories: categories,
  categoryList: categoryList,
  categorySearch: categorySearch,
  changeCustomerPassword: index$n,
  cmsBlocks: getCmsBlocks,
  cmsPage: getCmsPage,
  countries: countries,
  country: country,
  createCustomer: index$m,
  createCustomerAddress: createCustomerAddress,
  createEmptyCart: index$l,
  createProductReview: index$k,
  currency: currency,
  customer: index$j,
  customerCart: customerCart,
  customerOrders: index$i,
  customerProductReview: index$h,
  customMutation: index$g,
  customQuery: index$f,
  deleteCustomerAddress: deleteCustomerAddress,
  generateCustomerToken: index$e,
  getAvailableCustomerPaymentMethods: index$d,
  ...
  getAvailableShippingMethods: index$c,
  getCustomerAddresses: getCustomerAddresses,
  mergeCarts: index$b,
  placeOrder: placeOrder,
  productDetails: productDetails,
  productReview: index$a,
  productReviewRatingsMetadata: index$9,
  products: products,
  relatedProducts: relatedProducts,
  removeCouponFromCart: removeCouponFromCart,
  removeItemFromCart: removeItemFromCart,
  removeProductsFromWishlist: index$8,
  requestPasswordResetEmail: requestPasswordResetEmail,
  resetPassword: resetPassword,
  revokeCustomerToken: index$7,
  setBillingAddressOnCart: index$6,
  ...
  updateCustomer: index$5,
  updateCustomerAddress: updateCustomerAddress,
  updateCustomerEmail: index$4,
  upsellProducts: index$3,
...
const handleRetry = () => (count, operation, error) => {
    ...
    if (error?.result?.message === "invalid_token") {
        consola__default["default"].debug(`Apollo retry-link, the operation (${operation.operationName}) sent with wrong token, creating a new one... (attempt: ${count})`);
        return true;
    }
    return false;
};
const linkFactory = ({ state }) => setContext((apolloReq, { headers }) => {
    consola__default["default"].debug("Apollo linkFactory", apolloReq.operationName);
    const Store = state.getStore();
    const token = state.getCustomerToken();
    const currency = state.getCurrency();
    if (currency) {
        consola__default["default"].debug("Apollo currencyLinkFactory, finished, currency: ", currency);
    }
    if (Store) {
        consola__default["default"].debug("Apollo storeLinkFactory, finished, storeId: ", Store);
    }
    if (token) {
        consola__default["default"].debug("Apollo authLinkFactory, finished, token: ", token);
    }
    return {
        headers: {
            ...headers,
    ...
    if (graphQLErrors) {
        graphQLErrors.forEach(({ message, locations, path, extensions }) => {
            ...
            if (!message.includes("Resource Owner Password Credentials Grant")) {
                if (!locations) {
                    consola__default["default"].error(`[GraphQL error]: Message: ${message}, Path: ${path}`);
                    return;
                }
                const parsedLocations = locations.map(({ column, line }) => `[column: ${column}, line: ${line}]`);
                consola__default["default"].error(`[GraphQL error]: Message: ${message}, Location: ${parsedLocations.join(", ")}, Path: ${path}`);
            }
        });
    }
    if (networkError) {
        consola__default["default"].error(`[Network error]: ${networkError}`);
    }
});
...
const createMagentoConnection = (settings) => {
    consola__default["default"].debug("createMagentoConnection");
