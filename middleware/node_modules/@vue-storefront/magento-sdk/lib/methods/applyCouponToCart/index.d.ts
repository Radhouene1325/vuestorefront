...
export type ApplyCouponToCartMutation = {
    applyCouponToCart: Mutation['applyCouponToCart'];
};
/**
 ...
 * ```
 */
export declare function applyCouponToCart<RES extends ApplyCouponToCartResponse>(params: ApplyCouponToCartInput, options?: MethodOptions<CustomQuery<'applyCouponToCart'>>): Promise<RES>;
