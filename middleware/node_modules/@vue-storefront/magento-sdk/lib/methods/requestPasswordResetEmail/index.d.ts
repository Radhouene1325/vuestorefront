...
export type RequestPasswordResetEmailMutation = {
    requestPasswordResetEmail: Mutation['requestPasswordResetEmail'];
};
/**
 ...
 * ```
 */
export declare function requestPasswordResetEmail<RES extends RequestPasswordResetEmailResponse>(params: RequestPasswordResetEmailInput, options?: MethodOptions<CustomQuery<'requestPasswordResetEmail'>>): Promise<RES>;
