...
export type CreateProductReviewMutation = {
    createProductReview: Mutation['createProductReview'];
};
/**
 ...
 * ```
 */
export declare function createProductReview<RES extends CreateProductReviewResponse>(params: CreateProductReviewInput, options?: MethodBaseOptions): Promise<RES>;
