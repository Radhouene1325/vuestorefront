 ...
 */
export type CustomerAvailableShippingMethodsQuery = {
    customerCart: Query['customerCart'];
};
/**
 ...
 * ```
 */
export declare function getAvailableCustomerShippingMethods<RES extends GetAvailableCustomerShippingMethodsResponse>(options?: MethodOptions<CustomQuery<'getAvailableCustomerShippingMethods'>>): Promise<RES>;
