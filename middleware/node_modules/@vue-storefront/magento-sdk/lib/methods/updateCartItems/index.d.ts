...
export type UpdateCartItemsMutation = {
    updateCartItems: Mutation['updateCartItems'];
};
/**
 ...
 * ```
 */
export declare function updateCartItems<RES extends UpdateCartItemsResponse>(params: UpdateCartItemsInput, options?: MethodOptions<CustomQuery<'updateCartItems'>>): Promise<RES>;
