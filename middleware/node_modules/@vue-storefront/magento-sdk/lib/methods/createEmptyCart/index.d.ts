...
export type CreateEmptyCartMutation = {
    createEmptyCart: Mutation['createEmptyCart'];
};
/**
 ...
 * ```
 */
export declare function createEmptyCart<RES extends CreateEmptyCartResponse>(options?: MethodBaseOptions): Promise<RES>;
