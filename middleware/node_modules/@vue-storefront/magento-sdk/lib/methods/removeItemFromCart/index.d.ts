...
export type RemoveItemFromCartMutation = {
    removeItemFromCart: Mutation['removeItemFromCart'];
};
/**
 ...
 * ```
 */
export declare function removeItemFromCart<RES extends RemoveItemFromCartResponse>(params: RemoveItemFromCartInput, options?: MethodOptions<CustomQuery<'removeItemFromCart'>>): Promise<RES>;
