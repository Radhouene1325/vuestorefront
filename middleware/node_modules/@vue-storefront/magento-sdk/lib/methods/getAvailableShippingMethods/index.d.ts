 ...
 * ```
 */
export declare function getAvailableShippingMethods<RES extends GetAvailableShippingMethodsResponse>(params: GuestAvailableShippingMethodsQueryVariables, options?: MethodOptions<CustomQuery<'shippingMethods'>>): Promise<RES>;
