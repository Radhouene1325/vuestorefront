 ...
 * ```
 */
export declare function customMutation<RES extends CustomMutationResponse<any>, INPUT extends CustomMutationInput<any>>(params: INPUT, options?: MethodBaseOptions): Promise<RES>;
