...
export type SetShippingMethodsOnCartMutation = {
    setShippingMethodsOnCart: Mutation['setShippingMethodsOnCart'];
};
/**
 ...
 * ```
 */
export declare function setShippingMethodsOnCart<RES extends SetShippingMethodsOnCartResponse>(params: SetShippingMethodsOnCartInput, options?: MethodOptions<CustomQuery<'setShippingMethodsOnCart'>>): Promise<RES>;
