 ...
 */
export type AddConfigurableProductsToCartResponse<T extends DeepPartial<AddConfigurableProductsToCart> = AddConfigurableProductsToCart> = ApolloQueryResult<T>;
/**
 ...
 * ```
 */
export declare function addConfigurableProductsToCart<RES extends AddConfigurableProductsToCartResponse>(params: AddConfigurableProductsToCartInput, options?: MethodOptions<CustomQuery<'addConfigurableProductsToCart'>>): Promise<RES>;
