...
export type SetGuestEmailOnCartMutation = {
    setGuestEmailOnCart: Mutation['setGuestEmailOnCart'];
};
/**
 ...
 * ```
 */
export declare function setGuestEmailOnCart<RES extends SetGuestEmailOnCartResponse>(params: SetGuestEmailOnCartInput, options?: MethodBaseOptions): Promise<RES>;
