...
export type AddProductsToCartMutation = {
    addProductsToCart: Mutation['addProductsToCart'];
};
/**
 ...
 * ```
 */
export declare function addProductsToCart<RES extends AddProductsToCartResponse>(params: AddProductsToCartMutationVariables, options?: MethodOptions<CustomQuery<'addProductsToCart'>>): Promise<RES>;
