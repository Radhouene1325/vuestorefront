 ...
 * ```
 */
export declare function createCustomerAddress<RES extends CreateCustomerAddressResponse>(params: CustomerAddressInput, options?: MethodOptions<CustomQuery<'createCustomerAddress'>>): Promise<RES>;
