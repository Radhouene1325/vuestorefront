...
export type CreateCustomerMutation = {
    createCustomerV2: Mutation['createCustomerV2'];
};
/**
 ...
 * ```
 */
export declare function createCustomer<RES extends CreateCustomerResponse>(params: CustomerCreateInput, options?: MethodOptions<CustomQuery<'createCustomer'>>): Promise<RES>;
