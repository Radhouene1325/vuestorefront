 ...
 * ```
 */
export declare function categorySearch<RES extends CategorySearchResponse>(params?: CategorySearchQueryVariables, options?: MethodOptions<CustomQuery<'categorySearch'>>): Promise<RES>;
