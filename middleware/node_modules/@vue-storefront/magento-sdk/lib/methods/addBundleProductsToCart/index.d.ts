 ...
 */
export type AddBundleProductsToCartResponse<T extends DeepPartial<AddBundleProductsToCart> = AddBundleProductsToCart> = ApolloQueryResult<T>;
/**
 ...
 * ```
 */
export declare function addBundleProductsToCart<RES extends AddBundleProductsToCartResponse>(params: AddBundleProductsToCartInput, options?: MethodOptions<CustomQuery<'addBundleProductsToCart'>>): Promise<RES>;
