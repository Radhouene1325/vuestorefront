 ...
 */
export type GuestAvailablePaymentMethodsQuery = {
    cart: Query['cart'];
};
/**
 ...
 * ```
 */
export declare function getAvailablePaymentMethods<RES extends GetAvailablePaymentMethodsResponse>(params: GuestAvailablePaymentMethodsQueryVariables, options?: MethodBaseOptions): Promise<RES>;
