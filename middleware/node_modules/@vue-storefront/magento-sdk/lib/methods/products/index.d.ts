 ...
 * ```
 */
export declare function products<RES extends ProductsListResponse>(params: GetProductSearchParams, options?: MethodOptions<CustomQuery<'products'>>): Promise<RES>;
