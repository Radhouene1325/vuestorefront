 ...
 * ```
 */
export declare function upsellProducts<RES extends UpsellProductsResponse>(params: GetProductSearchParams, options?: MethodOptions<CustomQuery<'upsellProducts'>>): Promise<RES>;
