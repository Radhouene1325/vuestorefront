...
export type ChangeCustomerPasswordMutation = {
    changeCustomerPassword: Mutation['changeCustomerPassword'];
};
/**
 ...
 * ```
 */
export declare function changeCustomerPassword<RES extends ChangeCustomerPasswordResponse>(params: ChangeCustomerPasswordInput, options?: MethodOptions<CustomQuery<'changeCustomerPassword'>>): Promise<RES>;
