...
export type RemoveProductsFromWishlistMutation = {
    removeProductsFromWishlist: Mutation['removeProductsFromWishlist'];
};
/**
 ...
 * ```
 */
export declare function removeProductsFromWishlist<RES extends RemoveProductsFromWishlistResponse>(params: RemoveProductsFromWishlistMutationVariables, options?: MethodOptions<CustomQuery<'removeProductsFromWishlist'>>): Promise<RES>;
