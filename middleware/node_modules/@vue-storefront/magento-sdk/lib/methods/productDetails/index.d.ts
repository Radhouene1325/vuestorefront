 ...
 * ```
 */
export declare function productDetails<RES extends ProductDetailsResponse>(params: GetProductSearchParams, options?: MethodOptions<CustomQuery<'productDetails'>>): Promise<RES>;
