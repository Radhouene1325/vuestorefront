...
export type AddProductsToWishlistMutation = {
    addProductsToWishlist: Mutation['addProductsToWishlist'];
};
/**
 ...
 * ```
 */
export declare function addProductToWishList<RES extends AddProductToWishListResponse>(params: AddProductsToWishlistMutationVariables, options?: MethodOptions<CustomQuery<'addProductsToWishlist'>>): Promise<RES>;
