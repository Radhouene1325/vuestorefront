...
export type DeleteCustomerAddressMutation = {
    deleteCustomerAddress: Mutation['deleteCustomerAddress'];
};
/**
 ...
 * ```
 */
export declare function deleteCustomerAddress<RES extends DeleteCustomerAddressResponse>(params: DeleteCustomerAddressMutationVariables, options?: MethodBaseOptions): Promise<RES>;
