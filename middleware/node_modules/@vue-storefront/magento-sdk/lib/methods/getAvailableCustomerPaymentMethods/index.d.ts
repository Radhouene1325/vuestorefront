 ...
 */
export type CustomerAvailablePaymentMethodsQuery = {
    cart: Query['customerCart'];
};
/**
 ...
 * ```
 */
export declare function getAvailableCustomerPaymentMethods<RES extends GetAvailableCustomerPaymentMethodsResponse>(options?: MethodBaseOptions): Promise<RES>;
