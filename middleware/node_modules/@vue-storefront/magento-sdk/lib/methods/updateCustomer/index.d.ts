...
export type UpdateCustomerMutation = {
    updateCustomerV2: Mutation['updateCustomerV2'];
};
/**
 ...
 * ```
 */
export declare function updateCustomer<RES extends UpdateCustomerResponse>(params: CustomerUpdateInput, options?: MethodOptions<CustomQuery<'updateCustomer'>>): Promise<RES>;
