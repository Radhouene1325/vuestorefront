 ...
 * ```
 */
export declare function productReview<RES extends ProductReviewResponse>(params: GetProductSearchParams, options?: MethodOptions<CustomQuery<'productReview'>>): Promise<RES>;
