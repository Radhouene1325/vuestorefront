 ...
 * ```
 */
export declare function updateCustomerAddress<RES extends UpdateCustomerAddressResponse>(params: UpdateCustomerAddressMutationVariables, options?: MethodOptions<CustomQuery<'updateCustomerAddress'>>): Promise<RES>;
