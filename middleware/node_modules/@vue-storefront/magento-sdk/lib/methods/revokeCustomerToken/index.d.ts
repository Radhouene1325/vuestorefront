...
export type RevokeCustomerTokenMutation = {
    revokeCustomerToken: Mutation['revokeCustomerToken'];
};
/**
 ...
 * ```
 */
export declare function revokeCustomerToken<RES extends RevokeCustomerTokenResponse>(options?: MethodBaseOptions): Promise<RES>;
