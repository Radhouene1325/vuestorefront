...
export type SetShippingAddressesOnCartMutation = {
    setShippingAddressesOnCart: Mutation['setShippingAddressesOnCart'];
};
/**
 ...
 * ```
 */
export declare function setShippingAddressesOnCart<RES extends SetShippingAddressesOnCartResponse>(params: SetShippingAddressesOnCartInput, options?: MethodOptions<CustomQuery<'setShippingAddressesOnCart'>>): Promise<RES>;
