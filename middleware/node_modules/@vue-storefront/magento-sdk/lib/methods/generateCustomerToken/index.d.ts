...
export type GenerateCustomerTokenMutation = {
    generateCustomerToken: Mutation['generateCustomerToken'];
};
/**
 ...
 * ```
 */
export declare function generateCustomerToken<RES extends GenerateCustomerTokenResponse>(params: GenerateCustomerTokenInput, options?: MethodOptions<CustomQuery<'generateCustomerToken'>>): Promise<RES>;
