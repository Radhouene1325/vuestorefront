...
export type SubscribeEmailToNewsletterMutation = {
    subscribeEmailToNewsletter: Mutation['subscribeEmailToNewsletter'];
};
/**
 ...
 * ```
 */
export declare function subscribeEmailToNewsletter<RES extends SubscribeEmailToNewsletterResponse>(params: SubscribeEmailToNewsletterMutationVariables, options?: MethodBaseOptions): Promise<RES>;
