 ...
 */
export type CustomerProductReviewQuery = {
 ...
 * ```
 */
export declare function reviews<RES extends ReviewsResponse>(params?: CustomerProductReviewParams, options?: MethodOptions<CustomQuery<'reviews'>>): Promise<RES>;
