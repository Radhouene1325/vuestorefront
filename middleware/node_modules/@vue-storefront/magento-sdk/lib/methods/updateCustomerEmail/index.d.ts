...
export type UpdateCustomerEmailMutation = {
    updateCustomerEmail: Mutation['updateCustomerEmail'];
};
/**
 ...
 * ```
 */
export declare function updateCustomerEmail<RES extends UpdateCustomerEmailResponse>(params: UpdateCustomerEmailMutationVariables, options?: MethodOptions<CustomQuery<'updateCustomerEmail'>>): Promise<RES>;
