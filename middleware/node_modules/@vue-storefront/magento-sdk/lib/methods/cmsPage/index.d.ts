 ...
 * ```
 */
export declare function cmsPage<RES extends CmsPageResponse>(params: CmsPageQueryVariables, options?: MethodOptions<CustomQuery<'cmsPage'>>): Promise<RES>;
