...
export type RemoveCouponFromCartMutation = {
    removeCouponFromCart: Mutation['removeCouponFromCart'];
};
/**
 ...
 * ```
 */
export declare function removeCouponFromCart<RES extends RemoveCouponFromCartResponse>(params: RemoveCouponFromCartInput, options?: MethodOptions<CustomQuery<'removeCouponFromCart'>>): Promise<RES>;
