 ...
 * ```
 */
export declare function getCustomerAddresses<RES extends GetCustomerAddressesResponse>(options?: MethodOptions<CustomQuery<'getCustomerAddresses'>>): Promise<RES>;
