...
export type SetBillingAddressOnCartMutation = {
    setBillingAddressOnCart: Mutation['setBillingAddressOnCart'];
};
/**
 ...
 * ```
 */
export declare function setBillingAddressOnCart<RES extends SetBillingAddressOnCartResponse>(params: SetBillingAddressOnCartInput, options?: MethodOptions<CustomQuery<'setBillingAddressOnCart'>>): Promise<RES>;
