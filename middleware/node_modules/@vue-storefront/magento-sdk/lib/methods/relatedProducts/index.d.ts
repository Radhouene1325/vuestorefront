 ...
 * ```
 */
export declare function relatedProducts<RES extends RelatedProductsResponse>(params: GetProductSearchParams, options?: MethodOptions<CustomQuery<'relatedProducts'>>): Promise<RES>;
