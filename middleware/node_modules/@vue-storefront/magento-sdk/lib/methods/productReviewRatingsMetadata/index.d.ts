...
export type ProductReviewRatingsMetadataQuery = {
    productReviewRatingsMetadata: Query['productReviewRatingsMetadata'];
};
/**
 ...
 * ```
 */
export declare function productReviewRatingsMetadata<RES extends ProductReviewRatingsMetadataResponse>(options?: MethodOptions<CustomQuery<'productReviewRatingsMetadata'>>): Promise<RES>;
