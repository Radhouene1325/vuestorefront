...
export type SetPaymentMethodOnCartMutation = {
    setPaymentMethodOnCart: Mutation['setPaymentMethodOnCart'];
};
/**
 ...
 * ```
 */
export declare function setPaymentMethodOnCart<RES extends SetPaymentMethodOnCartResponse>(params: SetPaymentMethodOnCartInputs, options?: MethodOptions<CustomQuery<'setPaymentMethodOnCart'>>): Promise<RES>;
