 ...
 * ```
 */
export declare function cmsBlocks<RES extends CmsBlocksResponse>(params: CmsBlockQueryVariables, options?: MethodOptions<CustomQuery<'cmsBlocks'>>): Promise<RES>;
