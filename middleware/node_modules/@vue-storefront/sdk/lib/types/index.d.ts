 ...
 */
export type Extension<ExtendedModule extends Module = Module> = Omit<Partial<Module>, "connector" | "context"> & {
    /**
 ...
 */
export type SDKConfig = Readonly<Record<string, Module> & Record<string, Extension<Module>>>;
/**
 ...
 */
export type ModuleInitializer<InitializedModule extends Module, Options extends ModuleOptions> = (options?: Options) => InitializedModule;
/**
 * StrictModuleInitializer Type represents a function accepting mandatory module options
 * as an argument and returning the actual module.
 */
export type ModuleInitializerWithMandatoryOptions<InitializedModule extends Module, Options extends ModuleOptions> = (options: Options) => InitializedModule;
/**
 ...
 */
export type ExtensionInitializer<ExtendedModule extends Module, InitializedExtension extends Extension<ExtendedModule>, Options extends ModuleOptions> = (options: Options, parent: {
