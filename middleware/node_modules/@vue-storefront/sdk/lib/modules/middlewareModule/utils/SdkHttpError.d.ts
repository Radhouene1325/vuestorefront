 ...
 */
export type ErrorCausedBySDKError = Error & {
    cause: SdkHttpError;
};
/**
 ...
 * ```
 */
export declare const isCausedBySdkHttpError: (error: unknown) => error is ErrorCausedBySDKError;
/**
 ...
 * ```
 */
export declare const isSpecificSdkHttpError: (error: unknown, statusCodePredicate: SdkErrorPredicate) => error is ErrorCausedBySDKError;
/**
 ...
 * ```
 */
export declare const isSdkRequestError: (error: unknown) => error is ErrorCausedBySDKError;
/**
 ...
 * ```
 */
export declare const isSdkUnauthorizedError: (error: unknown) => error is ErrorCausedBySDKError;
//# sourceMappingURL=SdkHttpError.d.ts.map