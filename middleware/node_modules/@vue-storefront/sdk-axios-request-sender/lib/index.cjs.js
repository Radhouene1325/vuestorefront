...
class AxiosRequestSender {
    ...
    async GET() {
        ...
        return this.client.get(this.url, { params, ...this.config });
    }
    /**
     * HTTP POST request handler.
     */
    async POST() {
        return this.client.post(this.url, this.props, this.config);
    }
    /**
...
exports.AxiosRequestSender = AxiosRequestSender;
