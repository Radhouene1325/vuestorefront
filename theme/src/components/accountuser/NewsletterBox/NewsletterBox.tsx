...
export default function NewsletterBox() {
    const { trigger, data, error, isMutating } = useSWRMutation(
        `${BASEURL}/api/subscribeEmailToNewsletter/subscribeEmailToNewsletter`,
    ...
    const subscribeNewsletter = async (event: React.FormEvent<HTMLFormElement>, inputValue: string) => {
    ...
    console.log(data?.data?.subscribeEmailToNewsletter?.status)
                    ...
                    data?.data?.errors  && (
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={() => setErrorAlert(false)}
                            >
                                <SfIconClose className="hidden md:block" onClick={() => setErrorAlert(false)}/>
                                <SfIconClose size="sm" className="md:hidden block"/>
                            </button>
                        </div>
                    )
